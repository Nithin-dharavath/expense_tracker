---
name: "source-command-git-commit-push"
description: "Commit, push, create PR, merge, and clean up after a feature is complete"
---

# source-command-git-commit-push

Use this skill when the user asks to run the migrated source command `git-commit-push`.
...
```
Read .Codex/specs/ to find the spec for the current feature.
